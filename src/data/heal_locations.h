static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VANIVILLE_TOWN - 1] = {MAP_GROUP(VANIVILLE_TOWN), MAP_NUM(VANIVILLE_TOWN), 17, 5},
    [HEAL_LOCATION_AQUACORDE_TOWN - 1] = {MAP_GROUP(AQUACORDE_TOWN), MAP_NUM(AQUACORDE_TOWN), 10, 10},
};
